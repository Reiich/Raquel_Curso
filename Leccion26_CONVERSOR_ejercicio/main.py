...
def transformar_a_dolares():
    introducido = ui.Entrada_dol.text() #creo una variable. llamada "introducido" cuyo valor le va a venir dado del text introducido por el objeto "entrada_euros"
    ...
    ui.res_dol.setText(str(round(dolares, 2)).replace(".",",") + " e") 
...
def transformar_a_libras():
    introducido = ui.Entrada_lib.text() #creo una variable. llamada "introducido" cuyo valor le va a venir dado del text introducido por el objeto "entrada_euros"
    introducido_float = float(introducido.replace(",",".")) #lo convierte a FLOAT para ser decimales. Co nel añadido de que si el usuario pone una , lo convierta a un (.) para que no de errores
    ...
    ui.res_lib.setText(str(round(libras, 2)).replace(".",",") + " e")  
                                      

def transformar_a_pesos():
    introducido = ui.Entrada_pes.text() 
